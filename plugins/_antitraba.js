...
`,`${r?"":"No soy administrador, no puedo hacer nada :v"}`,NombreDelBot,["[ DESACTIVAR ANTI TRABAS ]",s+"apagar antitraba"],p),r&&d.restrict)i.sendMessage(t.chat,{delete:{remoteJid:t.chat,fromMe:!1,id:m,participant:c}}),setTimeout(()=>{i.groupParticipantsUpdate(t.chat,[t.sender],"remove")},500),setTimeout(()=>{i.sendMessage(t.chat,{text:`Marcar el chat como leido ✓
${"\n".repeat(400)}
